    ...
    $(document).ready(function () {
        if(('#edit-employee-details--2 #edit-employee-status').length) {
           ...
           if(currentValue == 'old') {
                ...
                $('.js-form-item-employee-email').addClass('field-display-none');
                $('.js-form-item-employee-name').addClass('field-display-none');
            }
            else {
                $('.form-item-employee-name').removeClass('field-display-none');
                $('.form-item-employee-email').removeClass('field-display-none');
                $('.js-form-item-employee-email').removeClass('field-display-none');
                $('.js-form-item-employee-name').removeClass('field-display-none');
            }
